package com.amirhome.droidmockup;
            ...
            holder.mView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mTwoPane) {
                        ...
                        arguments.putString(FoodDetailFragment.ARG_ITEM_ID, holder.mItem.id);
                        ...
                        intent.putExtra(FoodDetailFragment.ARG_ITEM_ID, holder.mItem.id);
